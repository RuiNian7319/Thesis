...
The average cost savings per barrel for January - May 2018 are shown in Table \ref{tab:08Cost_per_barrel}. Here, 
...
\begin{table}[h]
    ...
    \begin{tabular}{c|c|c|c|c|c}
        ...
        Saving / bbl (\$)      & 5.6     & 12.9     & 5.7   & 2.3   & 7.8 
    \end{tabular}}
...
\subsubsection{Benefit on Society}
