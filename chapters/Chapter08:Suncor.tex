...
\begin{table}[h]
    ...
    \begin{tabular}{ p{6cm} | c }
        ...
        CIG \& Ault Sweet DRA (ppm)             &      15 - 40            \\
        CIG \& Ault Sour DRA (ppm)              &      15 - 40            \\
    \end{tabular}}
...
\begin{table}[h]
    ...
    \begin{tabular}{ c | c }
        Binary                       &  Continuous           \\
        \hline
        3$\times$ On/off Cheyenne Pump  &  Cheyenne \& Fort Lupton VFD            \\
        On/off Fort Lupton Pump         &  2$\times$ Sweet \& 2$\times$ Sour DRA  \\
    \end{tabular}}
...
\noindent
\textit{Constraints}
The constraints comprised of equality and in-equality constraints.  
