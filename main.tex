...
\usepackage[backend=biber, bibstyle=ieee, maxcitenames=50]{biblatex} 
...
% \input{chapters/Chapter02MachineLearningforPrediction.tex}

% \chapter{Machine Learning for Process Monitoring}
% \input{chapters/Chapter03MachineLearningforMonitoring.tex}

\chapter{Machine Learning for Control Applications}
\input{chapters/Chapter04MachineLearningforControl.tex}

% \chapter{Review of RL for Process Control}
% \input{chapters/Chapter05ProcessControlRL.tex}

% \chapter{Concluding Remarks}
% \input{chapters/Chapter06Conclusion.tex}
