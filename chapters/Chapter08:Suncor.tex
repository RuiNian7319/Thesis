...
The operations cost for running the pipeline using the optimization tool was compared to historical values to identify the potential cost savings.  The data set ranging from January 2018 - May 2018 was used for this comparison due to the stability of operations.  In the 2019 data, the pipeline was plagued with unexpected shut downs and maintenances. Both the actual and optimal costs are calculated using the same formulation to ensure a fair comparison.  

First, the DRA cost was calculated by:
\begin{equation}
