...
To ensure the state space model is equivalent to the original transfer function model, step tests were conducted on both systems.  The input for $u_1$ and $u_2$ were set to 1 for 150 time steps and the output trajectory is shown in Figure \cite{XXX} for both the transfer function and state space models. From Figure \cite{XXX}, it can be seen that both trajectories are identical. Explain step test and inputs...

To further confirm the validity of the results, 
