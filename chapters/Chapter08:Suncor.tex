...
The initial data set contained one year data sampled
...
A linear parameter-varying model structure was selected to model this pipeline due to the bi-modal behaviour of the flow rate.  
