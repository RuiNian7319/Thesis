...
Figure \ref{fig:02USIS} shows the architecture for the USIS algorithm.  Initially, $n \geq 1$ models are present to model for the system.  

- Add effects of memory replay here for tuning of USIS.
- Tuning parameters: size of replay buffer, size of each bin, vigilance parameter, distance metric.
\begin{figure}
    \centering
