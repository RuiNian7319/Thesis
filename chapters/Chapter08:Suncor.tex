...
The hyper parameters for each neural network is given in Table \ref{tab:08NN_hp}. In all cases, the training and validation data set performance was significantly better using the neural networks.  However on the test data set, the performance was only slightly better.  This may be caused by the test data being slightly different than the training data.  Due to the complexity of neural networks, they perform exceptionally well on data
\begin{table}[h]
    \centering
    {\setstretch{1.2}
    \begin{tabular}{ c | c | c | c}
