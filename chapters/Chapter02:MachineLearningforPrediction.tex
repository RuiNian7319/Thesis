...
The methods and algorithms in this chapter were applied onto an industrial pipeline\footnote{Many values are significantly rounded and/or omitted to maintain confidentality of the project}.  The highlights of the implementation will be shown in this section.  For a detailed project report, please refer to Appendix A.
...
- ewma smoothing
- transforming features to be representative of how its actually used.
