...
The optimal and actual DRA, power and total costs are shown in Table \ref{tab:08opt_vs_act_costs}.  It can be seen that the total savings range between 29\% - 39\%.  The average DRA and power savings were 19.5\% and 45\%, respectively.  The power savings were much more significant because the models were able to exploit the most efficient pumps.  Additionally, the effectiveness of the pumps (i.e., flow rate as a function of current) were assumed to be constant; this may not be the case in actual production because pumps' efficiency changes with accordance to the pump curve \cite{fluid_mechanics}.  Likewise, DRA effectiveness was also assumed to be constant; however, preliminary data analysis showed a exponential decay relationship between flow rate and increased DRA.
...
\multicolumn{1}{c|}{}                            & Power cost & 128.8 & 124.3 & 106.4 & 116.9 & 122.4 \\
\multicolumn{1}{c|}{}                            & Total cost & 231.0 & 238.5 & 212.6 & 201.7 & 262.7 \\ \hline
...
\multicolumn{1}{c|}{\multirow{2}{*}{\rotatebox[origin=c]{90}{Diff.}}} & Dollars    & \textbf{88.8} & \textbf{93.7} & \textbf{59.6} & \textbf{57.6} & \textbf{76.0} \\
\multicolumn{1}{c|}{}                            & \% change        & \textbf{38} & \textbf{39} & \textbf{28} & \textbf{29} & \textbf{29}    
\end{tabular}}
    \caption{Optimal vs. actual costs (\$USD 000's) for January - May 2018.}
    \label{tab:08opt_vs_act_costs}
\end{table}

Length of this pipeline, applied to all of Canada, (Suncor is also a very efficient operator).  Total savings? (minus x days for turn arounds).
NPV?
Look at everything
