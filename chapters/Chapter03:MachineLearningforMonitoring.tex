...
Afterwards, logistic regression was applied onto the training data set.  The hyper parameters of the logistic regression is given in Table \ref{tab:03log_reg}.  Ultimately, the algorithm was able to achieve 98.6\% accuracy, 99\% precision and recall on
...
\begin{table}[H]
    \centering
    \begin{tabular}{ c | c | c }
        Detection & Prediction (Logistic Regression) & Prediction (Deep Learning) \\
        \hline
        2 & 5 & 1 \\
        2 & -2 & 0 \\
        5 & -1 & 1 \\
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Comparison of the best results achieved for anomaly detection and prediction.}
    \label{tab:03anomaly_detect_pred}
\end{table}
