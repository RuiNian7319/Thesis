...
The data set was split into three sections to validate and test the machine learning models: training, validation, test.  The partition and description of each section is described in Table \ref{tab:08datapart}.
