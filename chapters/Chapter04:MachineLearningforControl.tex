...
The reward function of the agent is given by the summation of the following three Equations:
\begin{equation}
...
Combining Equations \ref{eq:04r1}, \ref{eq:04r2}, and \ref{eq:04r3}, the scalar reward function for the agent is given by:
\begin{equation}
    r = r_1 + r_2 + r_3
...
\begin{table}[H]
	...
	\hspace{0.75cm} Observe dissolved oxygen level, $x_{o}$, in unit 5\\
	\hspace{0.75cm} Calculate error \emph{e}: $x_{o}$ - $x_{o, setpoint}$ \\
	...
	\hspace{2.25cm} \textbf{Do} first RL evaluation, \emph{skip} \\
	\hspace{2.25cm} \textbf{Else} Observe $r_t, \; x_{o, t+1}$, update $Q, \; N_t, \; T$ \\
	\hspace{2.25cm} $x_o \leftarrow x_{o, t+1}$ \\
	\hspace{1.5cm} Current state: $x_o$ \\
	\hspace{1.5cm} Apply \emph{reinforcement learning} to find optimal set-point change \\
	\hspace{1.5cm} Apply set-point change \\
...
\begin{table}[H]
	...
	\textbf{Initiate Plant Operations} \\
	\hspace{0.75cm} \textbf{Regulatory Control Layer} \\
	\hspace{0.75cm} Observe nitrogen level in unit 5\\
	\hspace{0.75cm} Calculate error \emph{e}: $x_{n}$ - $x_{n, setpoint}$ \\
	\hspace{0.75cm} Calculate $\Delta u_{N_2}$ from Equation \ref{eq:04discrete_pid} \\
	\hspace{1.5cm} \textbf{Supervisory Control Layer} \emph{every 15 mins} \\
	\hspace{2.25cm} \textbf{If} first RL evaluation, \emph{skip} \\
	\hspace{2.25cm} \textbf{Else} Observe $r_t, \; x_{n, t+1}$, update $Q, \; N_t, \; T$ \\
	\hspace{2.25cm} $x_n \leftarrow x_{n, t+1}$ \\
	\hspace{1.5cm} Current state: $x_n$ \\
	\hspace{1.5cm} Apply \emph{reinforcement learning} to find optimal set-point change \\
	\hspace{1.5cm} Apply set-point change \\
	\hspace{0.75cm} repeat forever or until terminal state \\
	\hline
